...
export const ZOMBIES: Record<ZombieId, ZombieDef> = {
  ...
  walker: { id: 'walker', tex: TextureKeys.ZombieGirlStand, hp: 71, speedMul: 1.0, bounty: 1, scale: 0.4, sheet: 'girl' },
  slow: { id: 'slow', tex: TextureKeys.ZombieSpeedStand, hp: 211, speedMul: 0.55, bounty: 1.8, scale: 0.34, sheet: 'speed' },
  brute: { id: 'brute', tex: TextureKeys.ZombieBruteStand, hp: 244, speedMul: 0.7, bounty: 2.2, scale: 0.46, sheet: 'brute' },
  ...
  boss: { id: 'boss', tex: TextureKeys.ZombieBossStand, hp: 1050, speedMul: 0.5, bounty: 8, scale: 0.5, sheet: 'boss',
    boss: { name: 'Dark Princess Oreo', skillCdMs: 9000, fill: '#5ee62e', outline: '#0a2a0c', glow: 0x2a5a1d } },
  khoai: { id: 'khoai', tex: TextureKeys.ZombieKhoaiStand, hp: 1650, speedMul: 0.5, bounty: 12, scale: 0.5, sheet: 'khoai',
    boss: { name: 'King Khoai', skillCdMs: 6500, fill: '#ff3b3b', outline: '#3a0606', glow: 0x5a1d1d } },
  hakj: { id: 'hakj', tex: TextureKeys.ZombieHakjStand, hp: 2400, speedMul: 0.55, bounty: 16, scale: 0.5, sheet: 'hakj',
