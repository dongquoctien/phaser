...
9. **Report** a pass/fail table: boot, canvas, console, FPS (measured), **UI layout (overlaps/offscreen/unreachable)**, **gameplay loop**, and saved screenshot paths. Stop the dev server.
